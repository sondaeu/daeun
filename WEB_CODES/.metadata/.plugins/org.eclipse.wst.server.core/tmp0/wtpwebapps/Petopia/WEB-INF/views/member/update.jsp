    ...
    <div class="center">
      ...
      <div class="section">
        ...
        <div class="info-update-tap">
          ...
          <div onclick="location.href='update'"
            class="info-update-tap-left">개인정보 수정</div>
        </div>
        <input type="hidden" value="${MemberVO.id }" id="id"> <strong>${MemberVO.id }</strong>님의
        정보입니다.<br>
        <table class="tbl_model">
          <tbody>
            ...
            <tr>
              <th>생년월일</th>
              <td><p>${MemberVO.birthday }</p> <br>
                <button id="dayButton" style="" onclick=display("updateDay","dayButton");>수정</button>
                <div style="display: none;" id="updateDay">
                  <p>변경할 자기소개</p>
                  <input type="date" id="birthday" name="birthday" style="text-indent:5px;">
                  <br> <br>
                  <button onclick=display("updateDay","dayButton");>수정
                    취소</button>
                  &nbsp; <input type="button" id="btnDay" value="수정완료">
                </div></td>
            </tr>
		...
		$(document).ready(function(){
		  ...
		  $('#btnDay').click(function(){
		    var birthday = $('#birthday').val();
			    ...
			    $.ajax({
			      type : 'POST',
			      url : '/hotel/member/updateBirthday',
			      headers : {
			        'Content-Type' : 'application/json',
	            	'X-HTTP-Method-Override' : 'POST'
			      },
