...
<body>
	...
	<div class="container">
		<div class="center">
			...
			<div id="Receive">
			<div class="list-title">받은 메세지함</div>
			<button class="GETList">받은 메세지</button>
  			<button class="SENDList">보낸 메세지</button>
			<div class="list-content">
			<table class="list-table" summary="번호, 분류, 종류, 내용, 작성일, 작성일">
							...
							<thead>
								<tr>
									...
									<th style="padding-left: 10px;">보낸이</th>
									<th>제목</th>
									<th>수신일</th>
								</tr>
							</thead>
							<tbody id="MylistData">
							<c:set var="num" value="${GETlist.size()}"></c:set>
